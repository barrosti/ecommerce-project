...
export class ProductListComponent implements OnInit {
  ...
  handleListProducts(){
    ...
    if(hasCategoryId){
      ...
      // not category ud available ... default to category id 1
      this.currentCategoryId = 1;
      this.currentCategoryName = 'Books';
    }

    //
    // Check if we have a different categogy than previous
    // Note: Angular will reuse a compononent if it is currently being viewed
